...
class ProductFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $productsData = [
            ...
            'Computer Components' => [
                [
                    'name' => 'Processors (Intel, AMD)',
                    'price' => 299.99,
                    'brand' => null,
                    'quantity' => 50,
                ],
                [
                    'name' => 'Graphics cards (NVIDIA, AMD)',
                    'price' => 699.99,
                    'brand' => null,
                    'quantity' => 40,
                ],
                [
                    'name' => 'RAM, SSDs, Hard drives',
                    'price' => 149.99,
                    'brand' => null,
                    'quantity' => 100,
                ],
                [
                    'name' => 'Motherboards, Power supplies',
                    'price' => 199.99,
                    'brand' => null,
                    'quantity' => 60,
                ],
            ...
            'Gaming Accessories' => [
                ...
                [
                    'name' => 'VR headsets (Meta Quest 3, PSVR2)',
                    'price' => 499.99,
                    'brand' => null,
                    'quantity' => 20,
                ],
            ...
            'External Storage' => [
                [
                    'name' => 'Seagate 2TB Portable Drive',
                    'price' => 89.99,
                    'brand' => 'Seagate',
                    'quantity' => 40,
                ],
